...
class Rain extends Component<PropsType>  {
    _yAnimation: Animated.Value
    color: any
    left: any
    _rotateAnimation: any
    _xAnimation: any
    static defaultProps: { duration: number; colors: string[]; size: number; bsize: number }
    constructor(props) {
        super(props)
        ...
        const xDistance = this.randomIntValue((windowWidth / 3 * -1), windowWidth / 3)
